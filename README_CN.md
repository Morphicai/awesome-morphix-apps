...
| 🎫 **code-manager** | 优惠券管理系统 - 创建、验证和管理优惠券 | MorphixAI Team | • 创建单个/批量优惠券<br>• 二维码验证<br>• 图片生成<br>• 云端存储<br>• 标签式导航 | ![code-manager](./apps/code-manager/screenshot/1.png) | [在线演示 →](https://app-shell.focusbe.com/app/d7d89e52-858c-4d73-9327-42a646afc12b) | [查看详情 →](https://github.com/Morphicai/awesome-morphix-apps/blob/main/apps/code-manager/README.md) |
